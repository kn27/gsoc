#install.library(c("maptools", "spdep", "rgdal"))
library(maptools);
library(spdep);
library(rgdal)
library(rstan);
...
load("./nyc_subset.data.R"); #GSOC/data/car_iar_poisson

nyc_shp<-readOGR("./nycTracts10", layer="nycTracts10"); #GSOC/data/car_iar_poisson
...
coords<-coordinates(nyc_subset_shp); #coordinates(clipped_nyc_subset_shp);
...
source("./nb_data_funs.R"); #GSOC/data/car_iar_poisson
